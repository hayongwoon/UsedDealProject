...
class LikeApiView(APIView):
    ...
    def post(self, request, product_id):
        LikeModel.objects.create(user_id=request.user.id, product_id=product_id)
    ...
    def delete(self, request, product_id):
        delete_cnt, _ = LikeModel.objects.filter(user_id=request.user.id, product_id=product_id).delete()
